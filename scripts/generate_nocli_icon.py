...
font = ImageFont.truetype(r"C:\Windows\Fonts\arialbd.ttf", 156)
text = "CLI"
box = draw.textbbox((0, 0), text, font=font, stroke_width=0)
draw.text(((512 - (box[2] - box[0])) / 2 - box[0], 170 - box[1]), text, font=font, fill="white")
draw.ellipse((79, 79, 433, 433), outline="#FF3B30", width=30)
draw.line((131, 131, 381, 381), fill="#FF3B30", width=34)
