...
contextBridge.exposeInMainWorld('nocli', {
  ...
  browserHide: () => ipcRenderer.invoke('browser-hide'),
    ...
    librarySetFolders: (folders) => ipcRenderer.invoke('library-set-folders', folders),
    libraryStatus: () => ipcRenderer.invoke('library-status'),
    libraryPickFolder: () => ipcRenderer.invoke('library-pick-folder'),
    researchSources: () => ipcRenderer.invoke('research-sources'),
    researchSearch: (query) => ipcRenderer.invoke('research-search', query),
    researchLibrarySearch: (query) => ipcRenderer.invoke('research-library-search', query),
