...
ok('Windows updates use the Windows installer feed', updateRepository('win32', {}) === 'Iyadobo/nocli.ai-releases' && releaseInstallerNames('win32', '1.2.3').join() === 'Calcium-Setup-1.2.3.exe');
