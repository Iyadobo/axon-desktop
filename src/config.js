...
const STATE_KEYS = new Set(['osettings', 'oprojects', 'oconvs', 'oswarmSessions', 'oautomations', 'omodel', 'oRuntime', 'oExoUrl', 'oLlamaCpp', 'olanHost', 'olanHostEnabled', 'oactiveProject', 'oactiveView', 'odraft', 'oworkspace', 'osharedConvs', 'ocloudModels', 'ouserProfile']);
