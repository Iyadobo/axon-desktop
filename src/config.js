...
const STATE_KEYS = new Set(['osettings', 'oprojects', 'oconvs', 'omodel', 'oRuntime', 'oExoUrl', 'oLlamaCpp', 'olanHost', 'olanHostEnabled', 'oactiveProject', 'oactiveView', 'odraft', 'oworkspace', 'osharedConvs', 'ocloudModels']);
